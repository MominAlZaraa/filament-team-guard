...
abstract class BaseLivewireComponent extends Component implements HasActions, HasForms
{
    ...
    {
        Notification::make()
            ->title(__('filament-team-guard::default.notification.rate_limited.title'))
            ->body(__('filament-team-guard::default.notification.rate_limited.message', ['seconds' => $exception->secondsUntilAvailable]))
            ->danger()
            ->send();
    }
